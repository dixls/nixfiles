{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-86555a18-e23d-4755-a435-9553e941168e" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,10,30,0,3,11.595";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."86555a18-e23d-4755-a435-9553e941168e" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "86555a18-e23d-4755-a435-9553e941168e";
      "kcminputrc"."Libinput/13652/62728/pulsar X2H Mini"."PointerAccelerationProfile" = 1;
      "kded5rc"."Module-device_automounter"."autoload" = false;
      "kdeglobals"."General"."AccentColor" = "204,115,110";
      "kdeglobals"."General"."LastUsedCustomAccentColor" = "204,115,110";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" = "/home/pixls/nixfiles/static/flower-wallpaper-1.gif";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage" = "/home/pixls/nixfiles/static/flower-wallpaper-1.gif";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "4005433e-761b-4920-ba5e-0c71aaed28a8";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/29d3d90d-9948-5129-99ea-d690ca6b2f23"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/40f7b7ff-1a83-5270-8f8c-6d9976e55658"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/a5bf11f6-3d17-5d74-a823-a294e144a849"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.6},{\"width\":0.15000000000000002}]}";
      "kwinrc"."Tiling/ec6a6e40-e1f6-5498-9a40-d223a2b231a6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    ...
    dataFile = {
      "dolphin/view_properties/global/.directory"."Dolphin"."HeaderColumnWidths" = "377,70,114";
